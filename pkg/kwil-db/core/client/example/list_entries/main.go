...
const (
	...
	// if running locally and port-forwarding use export PRIV_KEY=9167061a722d41dd5fb374c37bd6ed10ddd1b46c7d0016a5aaedae83c520fb00
)
...
func listTags(cl *client.Client, ctx context.Context, dbID string) {
	...
	// Call the 'get_all' action
	callResp, err := cl.Call(ctx, dbID, getAllAction, nil)
	if err != nil {
		log.Fatal(err)
	}

	// Access the records directly from callResp.Records
